...
report <- as_report.rough(readLines("./ac_reply2.Rmd"))
...
md <- rm.instFig(readLines("./mcnebula3.9_ac.md"))
writeLines(md, "./mcnebula4.0_ac.md")

n <- pandoc.docx("./mcnebula4.0_ac.md", hasLink = F)
n <- pandoc.docx("./legend3.4_NoSupp.md")
# pandoc.docx("./method_revise_ref.md", deal_with = F)

file.copy("./mcnebula4.0_ac.docx", "mcnebula.docx", T)
